...
function loadWoodExploreOutcome()
{
	...
	else if (airs >= 25 && airs < 50)
	{
		...
		{
			xhttp.onload = function() {document.getElementById("storylet").innerHTML = this.responseText;};
			xhttp.onreadystatechange = function() {if(this.readyState == 4 && this.status == 200){document.getElementById("displaychangingtext").innerHTML = "I follow some of these paths the creature scratched. Here, the roots and trees of the Wood are much more kinder than they are than normal, more light seems to break through the thick canopy, more candles light the way. I return to the clearing, and take note of some of the secret paths of the Wood."; document.getElementById("displaychangingtext2").innerHTML = "I follow the markings back to where they begun - the end of the path this time, as beginnings always have an end - and ends always have a beginning. I pick my way back to the clearing through the annoyances of the Wood.";}};
	...
	else
	{
		...
		{
			xhttp.onload = function() {document.getElementById("storylet").innerHTML = this.responseText;};
			xhttp.onreadystatechange = function() {if(this.readyState == 4 && this.status == 200){document.getElementById("displaychangingtext").innerHTML = "I cleave my path through a drooping canopy of thick vines, and a fantastical sight awaited - plump, red roses, moths flitting about, partaking in the Wood's gifts, before yielding so eagerly in the candle-flames that illuminate the scene like a tapestry. I flit among the moths for a while, learning their secrets to travelling the Wood, before settling upon having a drop of the rich, red nectar of the flowers. A singular plump, red drop -"; document.getElementById("displaychangingtext2").innerHTML = "Through a red and viscous haze, I awake, sprawled in the grass and roots of the clearing, yet again. I do not remember what transpired, yet I remember more of the moth-secrets of travelling the Wood.";}};
...
function loadShoreMain() 
{
	...
	xhttp.onreadystatechange = function() {if(this.readyState == 4 && this.status == 200){
		if(exploringShore == 1)
		{document.getElementById("changeoptiontitle").innerHTML = `Look Across the Sea`; document.getElementById("changeoptiontext").innerHTML = `Something seems to be approaching, disturbing the still seas...`; document.getElementById("changeoptionbutton").innerHTML = `<actionbutton onclick="loadShoreMainOutcome1()">Observe</actionbutton>`;}
		else if(exploringShore == 2)
		{document.getElementById("changeoptiontitle").innerHTML = `Approach the Boatman`; document.getElementById("changeoptiontext").innerHTML = `Its teeth twinkle in the starlight, its eyes hold something else - curiosity?`; document.getElementById("changeoptionbutton").innerHTML = `<actionbutton onclick="loadShoreMainOutcome2()">Approach</actionbutton>`;}
		else if(exploringShore == 3)
		{document.getElementById("changeoptiontitle").innerHTML = `Payment?`; document.getElementById("changeoptiontext").innerHTML = `You feel a heavy weight in your pocket...`; document.getElementById("changeoptionbutton").innerHTML = `<actionbutton onclick="loadShoreMainOutcome3()">Investigate</actionbutton>`;}
		else
		{document.getElementById("changeoptiontitle").innerHTML = `Boarding`; document.getElementById("changeoptiontext").innerHTML = `The Boatman climbs back into the boat, inviting you on board with a skeletal finger.`; document.getElementById("changeoptionbutton").innerHTML = `<actionbutton onclick="loadToBoat()">Board</actionbutton>`;}}};
...
function loadBoatMain() 
{
	...
	xhttp.onreadystatechange = function() {if(this.readyState == 4 && this.status == 200){
		if(exploringSea == 1)
		{document.getElementById("changeoptiontitle").innerHTML = `Wait`; document.getElementById("changeoptiontext").innerHTML = `Slowly, slowly, the dream-castle grows in size across the horizon...`; document.getElementById("changeoptionbutton").innerHTML = `<actionbutton onclick="loadBoatWaitOutcome1()">Wait</actionbutton>`;
		document.getElementById("changeoptiontitle2").innerHTML = `Look into the Sea`; document.getElementById("changeoptiontext2").innerHTML = `You see little glints of light under the waves, what are they?`; document.getElementById("changeoptionbutton2").innerHTML = `<actionbutton onclick="loadBoatLookOutcome1()">Look</actionbutton>`;}
		else if(exploringSea == 2)
		{document.getElementById("changeoptiontitle").innerHTML = `Wait More`; document.getElementById("changeoptiontext").innerHTML = `The boat rocks and sways on the Sea, the dream-castle is now almost at its original height, standing grand and majestic above all.`; document.getElementById("changeoptionbutton").innerHTML = `<actionbutton onclick="loadBoatWaitOutcome2()">Wait</actionbutton>`;	
		document.getElementById("changeoptiontitle2").innerHTML = `Look into the Sea Again`; document.getElementById("changeoptiontext2").innerHTML = `The waters are less murky, here. Something grand lurks beneath the waves, might you take a look?`; document.getElementById("changeoptionbutton2").innerHTML = `<actionbutton onclick="loadBoatLookOutcome2()">Look</actionbutton>`;}
		else 
		{document.getElementById("changeoptiontitle").innerHTML = `Disembark`; document.getElementById("changeoptiontext").innerHTML = `The boat rocks before the bridge to the dream-castle. It awaits in silent certainty.`; document.getElementById("changeoptionbutton").innerHTML = `<actionbutton onclick="loadBoatToBridgeOutcome()">Disembark</actionbutton>`; $('#action2').remove();}}};
}
...
function loadBridgeMain() 
{
	...
	xhttp.onreadystatechange = function() {if(this.readyState == 4 && this.status == 200){
		...
		{document.getElementById("changeoptiontitle").innerHTML = `Step by Step`; document.getElementById("changeoptiontext").innerHTML = `You have a ways to go until you approach the gates. Better start, then.`; document.getElementById("changeoptionbutton").innerHTML = `<actionbutton onclick="loadBridgeMainOutcome1()">Travel</actionbutton>`;}
		else
		{document.getElementById("changeoptiontitle").innerHTML = `Approach the Gates`; document.getElementById("changeoptiontext").innerHTML = `The gates to the dream-castle are not much further, now. Only a little more to go -`; document.getElementById("changeoptionbutton").innerHTML = `<actionbutton onclick="loadToGate()">Approach</actionbutton>`;}}};
...
function loadGates()
{
	...
	xhttp.onreadystatechange = function() {if(this.readyState == 4 && this.status == 200){
		if (exploringBridge == 1)
		{document.getElementById("changeoptiontitle").innerHTML = `Approach the Gates`; document.getElementById("changeoptiontext").innerHTML = `Prepare to open them, if you can.`; document.getElementById("changeoptionbutton").innerHTML = `<actionbutton onclick="loadGateMainOutcome1()"></actionbutton>`;}
		else
		{document.getElementById("changeoptiontitle").innerHTML = `Open the Gates`; document.getElementById("changeoptiontext").innerHTML = `The gates will open with the help of the Stars, who have formed into Constellations.`; document.getElementById("changeoptionbutton").innerHTML = `<actionbutton onclick="loadToConstellarium()"></actionbutton>`;}}};
